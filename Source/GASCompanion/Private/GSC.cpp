...
void FGSCModule::OnPostEngineInit()
{
	...
	GSC_LOG(Verbose, TEXT("GSCModule::PostEngineInit - AbilitySystemGlobals Initialized: %s (Num: %d)"), *GetBoolText(bStructsCacheInitialized), StructsCache.Num())
	GSC_LOG(Verbose, TEXT("GSCModule::PostEngineInit - AbilitySystemGlobals IsAbilitySystemGlobalsInitialized() returns %s"), *GetBoolText(UAbilitySystemGlobals::Get().IsAbilitySystemGlobalsInitialized()))
