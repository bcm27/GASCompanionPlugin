...
private:
	...
	void TryGrantAbility(UAbilitySystemComponent* AbilitySystemComponent, TSubclassOf<UGameplayAbility> AbilityType, OUT FGameplayAbilitySpecHandle& AbilityHandle, OUT FGameplayAbilitySpec& AbilitySpec);
	...
	void TryGrantAttributes(UAbilitySystemComponent* AbilitySystemComponent, const FGSCGameFeatureAttributeSetMapping& AttributeSetMapping, OUT FActorExtensions& AddedExtensions);
