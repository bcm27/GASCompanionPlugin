...
class UScriptStruct* FGSCGameplayEffectCreationData::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GSCGameplayEffectCreationData.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData, Z_Construct_UPackage__Script_GASCompanionEditor(), TEXT("GSCGameplayEffectCreationData"));
	}
...
template<> GASCOMPANIONEDITOR_API UScriptStruct* StaticStruct<FGSCGameplayEffectCreationData>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_MenuPath = { "MenuPath", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectCreationData, MenuPath), METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_MenuPath_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_MenuPath_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_BaseName = { "BaseName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectCreationData, BaseName), METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_BaseName_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_BaseName_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_ParentClass = { "ParentClass", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectCreationData, ParentClass), Z_Construct_UClass_UGSCTemplate_GameplayEffectDefinition_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_ParentClass_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_ParentClass_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_AssetPrefix_MetaData[] = {
		{ "Comment", "// UPROPERTY(EditAnywhere, Category = \"Gameplay Effect\", meta=(DisplayName = \"Gameplay Effect Template\"))\n// TSubclassOf<UGSCTemplate_GameplayEffectDefinition> GameplayEffectTemplateClass;\n" },
		{ "ModuleRelativePath", "Public/CreationMenu/GSCGameplayEffectCreationMenu.h" },
		{ "ToolTip", "UPROPERTY(EditAnywhere, Category = \"Gameplay Effect\", meta=(DisplayName = \"Gameplay Effect Template\"))\nTSubclassOf<UGSCTemplate_GameplayEffectDefinition> GameplayEffectTemplateClass;" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_AssetPrefix = { "AssetPrefix", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectCreationData, AssetPrefix), METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_AssetPrefix_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_AssetPrefix_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FTextPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_TooltipText = { "TooltipText", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectCreationData, TooltipText), METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_TooltipText_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewProp_TooltipText_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::Struct_MetaDataParams))
	};
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::NewProp_Definitions_Inner = { "Definitions", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, 0, Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData, METADATA_PARAMS(nullptr, 0) }; // 297543401
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::NewProp_Definitions = { "Definitions", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGSCGameplayEffectCreationMenu, Definitions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::NewProp_Definitions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::NewProp_Definitions_MetaData)) }; // 297543401
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::ClassParams = {
		...
		0,
		0x001002A6u,
		METADATA_PARAMS(Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCGameplayEffectCreationMenu_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics::ScriptStructInfo[] = {
		{ FGSCGameplayEffectCreationData::StaticStruct, Z_Construct_UScriptStruct_FGSCGameplayEffectCreationData_Statics::NewStructOps, TEXT("GSCGameplayEffectCreationData"), &Z_Registration_Info_UScriptStruct_GSCGameplayEffectCreationData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGSCGameplayEffectCreationData), 297543401U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGSCGameplayEffectCreationMenu, UGSCGameplayEffectCreationMenu::StaticClass, TEXT("UGSCGameplayEffectCreationMenu"), &Z_Registration_Info_UClass_UGSCGameplayEffectCreationMenu, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGSCGameplayEffectCreationMenu), 3381523929U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_3916296584(TEXT("/Script/GASCompanionEditor"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanionEditor_Public_CreationMenu_GSCGameplayEffectCreationMenu_h_Statics::ScriptStructInfo),
		nullptr, 0);
