...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_AGSCModularDefaultPawn_Statics::NewProp_ReplicationMode = { "ReplicationMode", nullptr, (EPropertyFlags)0x0010000000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGSCModularDefaultPawn, ReplicationMode), Z_Construct_UEnum_GameplayAbilities_EGameplayEffectReplicationMode, METADATA_PARAMS(Z_Construct_UClass_AGSCModularDefaultPawn_Statics::NewProp_ReplicationMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGSCModularDefaultPawn_Statics::NewProp_ReplicationMode_MetaData)) }; // 257345416
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGSCModularDefaultPawn_Statics::NewProp_AbilitySystemComponent = { "AbilitySystemComponent", nullptr, (EPropertyFlags)0x00100000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGSCModularDefaultPawn, AbilitySystemComponent), Z_Construct_UClass_UGSCAbilitySystemComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AGSCModularDefaultPawn_Statics::NewProp_AbilitySystemComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGSCModularDefaultPawn_Statics::NewProp_AbilitySystemComponent_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGSCModularDefaultPawn_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AGSCModularDefaultPawn_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UAbilitySystemInterface_NoRegister, (int32)VTABLE_OFFSET(AGSCModularDefaultPawn, IAbilitySystemInterface), false },  // 220555618
		};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AGSCModularDefaultPawn_Statics::ClassParams = {
		...
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AGSCModularDefaultPawn_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AGSCModularDefaultPawn_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularDefaultPawn_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularDefaultPawn_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGSCModularDefaultPawn, AGSCModularDefaultPawn::StaticClass, TEXT("AGSCModularDefaultPawn"), &Z_Registration_Info_UClass_AGSCModularDefaultPawn, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGSCModularDefaultPawn), 90806455U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularDefaultPawn_h_323513383(TEXT("/Script/GASCompanion"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularDefaultPawn_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularDefaultPawn_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
