...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGSCLinkAnimLayersComponent_Statics::NewProp_LayerTypes = { "LayerTypes", nullptr, (EPropertyFlags)0x0014000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGSCLinkAnimLayersComponent, LayerTypes), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGSCLinkAnimLayersComponent_Statics::NewProp_LayerTypes_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCLinkAnimLayersComponent_Statics::NewProp_LayerTypes_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGSCLinkAnimLayersComponent_Statics::ClassParams = {
		...
		0,
		0x00B000A4u,
		METADATA_PARAMS(Z_Construct_UClass_UGSCLinkAnimLayersComponent_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCLinkAnimLayersComponent_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Components_GSCLinkAnimLayersComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Components_GSCLinkAnimLayersComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGSCLinkAnimLayersComponent, UGSCLinkAnimLayersComponent::StaticClass, TEXT("UGSCLinkAnimLayersComponent"), &Z_Registration_Info_UClass_UGSCLinkAnimLayersComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGSCLinkAnimLayersComponent), 1417624726U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Components_GSCLinkAnimLayersComponent_h_2864689683(TEXT("/Script/GASCompanion"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Components_GSCLinkAnimLayersComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Components_GSCLinkAnimLayersComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
