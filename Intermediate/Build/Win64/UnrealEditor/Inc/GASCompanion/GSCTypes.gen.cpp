...
// End Cross Module References
	...
	static UEnum* EGSCAbilityTriggerEvent_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EGSCAbilityTriggerEvent.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_GASCompanion_EGSCAbilityTriggerEvent, Z_Construct_UPackage__Script_GASCompanion(), TEXT("EGSCAbilityTriggerEvent"));
		}
	...
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_GASCompanion_EGSCAbilityTriggerEvent_Statics::EnumParams = {
		...
		METADATA_PARAMS(Z_Construct_UEnum_GASCompanion_EGSCAbilityTriggerEvent_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_GASCompanion_EGSCAbilityTriggerEvent_Statics::Enum_MetaDataParams))
	};
...
class UScriptStruct* FGSCGameplayEffectContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GSCGameplayEffectContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer, Z_Construct_UPackage__Script_GASCompanion(), TEXT("GSCGameplayEffectContainer"));
	}
...
template<> GASCOMPANION_API UScriptStruct* StaticStruct<FGSCGameplayEffectContainer>()
{
...
#endif
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_TargetType = { "TargetType", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectContainer, TargetType), Z_Construct_UClass_UGSCTargetType_NoRegister, Z_Construct_UClass_UClass, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_TargetType_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_TargetType_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_TargetGameplayEffectClasses = { "TargetGameplayEffectClasses", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectContainer, TargetGameplayEffectClasses), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_TargetGameplayEffectClasses_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_TargetGameplayEffectClasses_MetaData)) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_bUseSetByCallerMagnitude = { "bUseSetByCallerMagnitude", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FGSCGameplayEffectContainer), &Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_bUseSetByCallerMagnitude_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_bUseSetByCallerMagnitude_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_bUseSetByCallerMagnitude_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_SetByCallerDataTag = { "SetByCallerDataTag", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectContainer, SetByCallerDataTag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_SetByCallerDataTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_SetByCallerDataTag_MetaData)) }; // 802167388
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_SetByCallerMagnitude = { "SetByCallerMagnitude", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectContainer, SetByCallerMagnitude), METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_SetByCallerMagnitude_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::NewProp_SetByCallerMagnitude_MetaData)) };
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainer_Statics::Struct_MetaDataParams))
	};
...
class UScriptStruct* FGSCGameplayEffectContainerSpec::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GSCGameplayEffectContainerSpec.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec, Z_Construct_UPackage__Script_GASCompanion(), TEXT("GSCGameplayEffectContainerSpec"));
	}
...
template<> GASCOMPANION_API UScriptStruct* StaticStruct<FGSCGameplayEffectContainerSpec>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewProp_TargetData = { "TargetData", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectContainerSpec, TargetData), Z_Construct_UScriptStruct_FGameplayAbilityTargetDataHandle, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewProp_TargetData_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewProp_TargetData_MetaData)) }; // 3993235140
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewProp_TargetGameplayEffectSpecs = { "TargetGameplayEffectSpecs", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FGSCGameplayEffectContainerSpec, TargetGameplayEffectSpecs), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewProp_TargetGameplayEffectSpecs_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewProp_TargetGameplayEffectSpecs_MetaData)) }; // 1303953225
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::Struct_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics::EnumInfo[] = {
		{ EGSCAbilityTriggerEvent_StaticEnum, TEXT("EGSCAbilityTriggerEvent"), &Z_Registration_Info_UEnum_EGSCAbilityTriggerEvent, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3756966630U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FGSCGameplayEffectContainerSpec::StaticStruct, Z_Construct_UScriptStruct_FGSCGameplayEffectContainerSpec_Statics::NewStructOps, TEXT("GSCGameplayEffectContainerSpec"), &Z_Registration_Info_UScriptStruct_GSCGameplayEffectContainerSpec, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGSCGameplayEffectContainerSpec), 3085220630U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_2655569768(TEXT("/Script/GASCompanion"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Abilities_GSCTypes_h_Statics::EnumInfo));
