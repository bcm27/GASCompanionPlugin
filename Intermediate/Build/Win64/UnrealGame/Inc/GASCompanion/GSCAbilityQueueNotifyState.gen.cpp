...
// End Cross Module References
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_bAllowAllAbilities = { "bAllowAllAbilities", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(UGSCAbilityQueueNotifyState), &Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_bAllowAllAbilities_SetBit, METADATA_PARAMS(Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_bAllowAllAbilities_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_bAllowAllAbilities_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_AllowedAbilities = { "AllowedAbilities", nullptr, (EPropertyFlags)0x0014000000000015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UGSCAbilityQueueNotifyState, AllowedAbilities), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_AllowedAbilities_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::NewProp_AllowedAbilities_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::ClassParams = {
		...
		0,
		0x001130A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGSCAbilityQueueNotifyState_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Animations_GSCAbilityQueueNotifyState_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Animations_GSCAbilityQueueNotifyState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGSCAbilityQueueNotifyState, UGSCAbilityQueueNotifyState::StaticClass, TEXT("UGSCAbilityQueueNotifyState"), &Z_Registration_Info_UClass_UGSCAbilityQueueNotifyState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGSCAbilityQueueNotifyState), 2704351516U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Animations_GSCAbilityQueueNotifyState_h_74987529(TEXT("/Script/GASCompanion"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Animations_GSCAbilityQueueNotifyState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_Animations_GSCAbilityQueueNotifyState_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
