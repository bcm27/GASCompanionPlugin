...
// End Cross Module References
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGSCModularPlayerStateCharacter_Statics::Class_MetaDataParams[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_AGSCModularPlayerStateCharacter_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_UAbilitySystemInterface_NoRegister, (int32)VTABLE_OFFSET(AGSCModularPlayerStateCharacter, IAbilitySystemInterface), false },  // 220555618
		};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_AGSCModularPlayerStateCharacter_Statics::ClassParams = {
		...
		0x009000A4u,
		METADATA_PARAMS(Z_Construct_UClass_AGSCModularPlayerStateCharacter_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_AGSCModularPlayerStateCharacter_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularPlayerStateCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularPlayerStateCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGSCModularPlayerStateCharacter, AGSCModularPlayerStateCharacter::StaticClass, TEXT("AGSCModularPlayerStateCharacter"), &Z_Registration_Info_UClass_AGSCModularPlayerStateCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGSCModularPlayerStateCharacter), 2490628841U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularPlayerStateCharacter_h_2989270581(TEXT("/Script/GASCompanion"),
		Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularPlayerStateCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_HostProject_Plugins_GASCompanion_Source_GASCompanion_Public_ModularGameplayActors_GSCModularPlayerStateCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
